# -*- coding: utf-8 -*-
#
# Sarge documentation build configuration file, created by
...
project = u'Sarge'
copyright = u'2012-%s, Vinay Sajip' % datetime.date.today().year
...
from sarge import __version__ as release, __date__ as today
...
latex_documents = [
  ('index', 'Sarge.tex', u'Sarge Documentation',
...
epub_copyright = u'2012-2013, Vinay Sajip'
